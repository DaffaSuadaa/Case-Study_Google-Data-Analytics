...
You can see the running program with R here: [Google Data Analytics-Capstone Case Study-1](https://www.kaggle.com/code/daffasuadaa/google-data-analytics-capstone-case-study-1)
